...
class Parser:
    ...
    def parse_arguments(self):
        ...
        parser.add_argument('--shift_amount', type=int, default=24, help="number of bits to shift when quantizing weights")

        parser.add_argument('--checkpoint', type=str, default="", help="Saved '.pth' model to start from")
